...
namespace kinjo{
    ...
    {
        const int SEASONS = 4;
        public LoadData LoadSceneData(string dataPath)
        {
            ...
            // 読み取った文字列をオブジェクト型に変換
            LoadData inputJson = JsonUtility.FromJson<LoadData>(datastr);
        ...
        public void SaveSceneData(LoadData loadData, string dataPath)
        {
